...
- [x] Dirección visual y componentes neobrutalistas consolidados (Spec_T8 / Spec_T9).
- [x] Etapa 5 (SEO técnico, Fuentes locales, Sitemap, Robots, Open Graph, Hreflang, Performance y QA) implementada.
